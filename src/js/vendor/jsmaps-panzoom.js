...
! function() { "use strict";
    ...
    function e(e, t) { var r, n, i; return e.pageX || e.pageY ? (r = e.pageX, n = e.pageY) : (r = e.clientX + document.body.scrollLeft + document.documentElement.scrollLeft, n = e.clientY + document.body.scrollTop + document.documentElement.scrollTop), i = o(t), r -= i[0], n -= i[1], { x: r, y: n } } var t = { enable: function() { this.enabled = !0 }, disable: function() { this.enabled = !1 }, zoomIn: function(o) { this.applyZoom(o) }, zoomOut: function(o) { this.applyZoom(o > 0 ? -1 * o : o) }, zoomReset: function() { this.resetZoom() }, pan: function(o, e) { this.applyPan(-1 * o, -1 * e) }, isDragging: function() { return this.dragTime > this.dragThreshold }, getCurrentPosition: function() { return this.currPos }, getCurrentZoom: function() { return this.currZoom } },
        r = function(o, t) {
            function r() { l.currPos.x = l.currPos.x + f, l.currPos.y = l.currPos.y + p; var o = h.originWidth * (1 - l.currZoom * h.zoomStep),
            ...
            function n(o) { if (!l.enabled) return !1; var t = window.event || o,
                    n = s.width * (1 - l.currZoom * h.zoomStep),
                    i = s.height * (1 - l.currZoom * h.zoomStep),
                    u = e(t, c); return f = n * (u.x - d.x) / s.width * -1, p = i * (u.y - d.y) / s.height * -1, d = u, r(), l.dragTime += 1, t.preventDefault ? t.preventDefault() : t.returnValue = !1, !1 }

            function i(o, e) { if (!l.enabled) return !1;
            ...
            function u() { if (!l.enabled) return !1;
                l.currZoom = f = p = 0, r() }

            function a(o) { if (!l.enabled) return !1; var t = window.event || o,
                    r = t.detail || -1 * t.wheelDelta,
                    n = e(t, c); return r > 0 ? r = -1 : r < 0 && (r = 1), i(r, n), t.preventDefault ? t.preventDefault() : t.returnValue = !1, !1 }

            function m(o, e) { f = o, p = e, r() } var s = o,
